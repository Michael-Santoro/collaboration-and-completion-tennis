...
torch.save(agent.actor_mean.state_dict(), 'ppo/checkpoint_ppo_agent_actor_mean.pth')
torch.save(agent.critic.state_dict(), 'ppo/checkpoint_ppo_agent_critic.pth')
...
ppo_logs.to_csv('ppo/ppo_records_logs.csv')
